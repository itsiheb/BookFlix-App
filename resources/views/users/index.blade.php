  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href=""><h2>Book <em>Flix</em></h2></a>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <a class="btn-sm btn-dark" href="{{route('demandes.create',$book->id)}}">Request</a>
              <a class="btn-sm btn-secondary" href="{{route('demandes.show',$book->id)}}">Get with Bonus</a>
